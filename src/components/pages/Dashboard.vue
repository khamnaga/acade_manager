<template lang="html">
        ...
        <div id="dash">
              ...
              <div class="wrapper">
                  <form @submit.prevent class="login-right">
                      ...
                      <input @click.prevent="post" type="submit" value="CREER SESSION" class="btn">
...
export default {
    ...
    data() {
        return {
            session: {
                // objet SESSION dont les propriétés sont NULL au départ
    ...
    methods: {
        post(e) {
            console.log("session entitled:",this.session.entitled);
            console.log("session name:",this.session.name);
            console.log("session start_date:",this.session.start_date);
            console.log("session end_date:",this.session.end_date);
            console.log("session admin_firstname:",this.session.admin_firstname);
            console.log("session admin_lastname:",this.session.admin_lastname);

            axios({
                method: 'post',
                url: "http://localhost:3001/sessions",
                data: {
                    entitled:        this.session.entitled,
                ...
                console.log("test:", this.message = response.data);
